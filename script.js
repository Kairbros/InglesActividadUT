...
let orden_correcto = ['if it rains', 'if you mix red and blue', 'if it rains tomorrow', 'if you eat a lot of chocolate', 'if she doesn´t pay attention', 'they will get a big prize', 'you will be late'];

//Palabras desordenadas para mostrar en opciones
let palabras_juego = ['you will be late', 'if you mix red and blue', 'if it rains', 'they will get a big prize', 'if she doesn´t pay attention', 'if you eat a lot of chocolate', 'if it rains tomorrow'];
...
comprobar.onclick = function(){
    ...
    if(posLibre==-1){
        ...
        if(totalAciertos==orden_correcto.length){
            ...
            txtResultado.innerHTML = "¡Algunas estan mal!";
        }
    }else{
